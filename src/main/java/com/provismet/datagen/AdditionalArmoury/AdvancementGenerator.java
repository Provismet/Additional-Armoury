...
public class AdvancementGenerator extends FabricAdvancementProvider {
    ...
    public void generateAdvancement (Consumer<Advancement> consumer) {
        ...
        EnchantedItemCriterion.Conditions staffCondition = new EnchantedItemCriterion.Conditions(LootContextPredicate.EMPTY, ItemPredicate.Builder.create().items(AAItems.STAFF).build(), NumberRange.IntRange.ANY);
        Advancement enchanter = Advancement.Builder.create().build(new Identifier("story/enchant_item"));
        Advancement enchantStaff = Advancement.Builder.create().parent(enchanter)
            .display(
                enchantedStaff,
        ...
        Advancement.Builder.create().parent(enchantStaff)
            ...
            .criterion("used_explosion_magic", new ImpossibleCriterion.Conditions())
            .build(consumer, AdditionalArmouryMain.identifier("story/explosion_magic").toString());

        Advancement dragonBreath = Advancement.Builder.create().build(new Identifier("end/dragon_breath"));
        ...
        Advancement ancientDebris = Advancement.Builder.create().build(new Identifier("nether/obtain_ancient_debris"));
